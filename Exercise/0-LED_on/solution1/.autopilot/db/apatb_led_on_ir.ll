...
define void @apatb_led_on_ir(i8* noalias nocapture nonnull %o_led) local_unnamed_addr #0 {
entry:
  %o_led_copy = alloca i8, align 512
  call fastcc void @copy_in(i8* nonnull %o_led, i8* nonnull align 512 %o_led_copy)
  call void @apatb_led_on_hw(i8* %o_led_copy)
  call void @copy_back(i8* %o_led, i8* %o_led_copy)
  ret void
}
...
declare void @led_on_hw_stub(i8*)
