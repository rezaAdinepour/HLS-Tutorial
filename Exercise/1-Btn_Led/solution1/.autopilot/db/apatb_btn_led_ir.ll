; ModuleID = 'C:/OneDrive/Desktop/HLS-Tutorial/Exercise/1-Btn_Led/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: inaccessiblemem_or_argmemonly noinline willreturn
define i8 @apatb_btn_led_ir(i8 returned zeroext %btn) local_unnamed_addr #0 {
entry:
  call fastcc void @copy_in()
  %0 = call i8 @apatb_btn_led_hw(i8 %btn)
  call void @copy_back()
  ret i8 %0
}
...
declare i8 @apatb_btn_led_hw(i8)
...
define i8 @btn_led_hw_stub_wrapper(i8) #3 {
entry:
  call void @copy_out()
  %1 = call i8 @btn_led_hw_stub(i8 %0)
  call void @copy_in()
  ret i8 %1
}

declare i8 @btn_led_hw_stub(i8)
