...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("ew", 1, hls_out, 4, "ap_none", "out_data", 1),
	Port_Property("ns", 1, hls_out, 5, "ap_none", "out_data", 1),
};
const char* HLS_Design_Meta::dut_name = "trafic_light_controller";
