; ModuleID = 'C:/OneDrive/Desktop/HLS-Tutorial/Take-Home-Ex/7-C_Cpp_Testbench/Ex1/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: inaccessiblemem_or_argmemonly noinline willreturn
define void @apatb_trafic_light_controller_ir(i1 zeroext %l_sensor, i1 zeroext %r_sensor, i1 zeroext %u_sensor, i1 zeroext %d_sensor, i1* noalias nocapture nonnull %ew, i1* noalias nocapture nonnull %ns) local_unnamed_addr #0 {
entry:
  %ew_copy = alloca i1, align 512
  %ns_copy = alloca i1, align 512
  call fastcc void @copy_in(i1* nonnull %ew, i1* nonnull align 512 %ew_copy, i1* nonnull %ns, i1* nonnull align 512 %ns_copy)
  call void @apatb_trafic_light_controller_hw(i1 %l_sensor, i1 %r_sensor, i1 %u_sensor, i1 %d_sensor, i1* %ew_copy, i1* %ns_copy)
  call void @copy_back(i1* %ew, i1* %ew_copy, i1* %ns, i1* %ns_copy)
  ret void
}
...
declare void @apatb_trafic_light_controller_hw(i1, i1, i1, i1, i1*, i1*)
...
define void @trafic_light_controller_hw_stub_wrapper(i1, i1, i1, i1, i1*, i1*) #4 {
entry:
  call void @copy_out(i1* null, i1* %4, i1* null, i1* %5)
  call void @trafic_light_controller_hw_stub(i1 %0, i1 %1, i1 %2, i1 %3, i1* %4, i1* %5)
  call void @copy_in(i1* null, i1* %4, i1* null, i1* %5)
  ret void
}

declare void @trafic_light_controller_hw_stub(i1, i1, i1, i1, i1*, i1*)
