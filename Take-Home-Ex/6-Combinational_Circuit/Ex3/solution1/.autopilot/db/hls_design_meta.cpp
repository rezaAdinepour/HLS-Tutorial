...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("M", 1, hls_out, 8, "ap_none", "out_data", 1),
	Port_Property("N", 1, hls_out, 9, "ap_none", "out_data", 1),
	Port_Property("P", 1, hls_out, 10, "ap_none", "out_data", 1),
};
const char* HLS_Design_Meta::dut_name = "comprator";
