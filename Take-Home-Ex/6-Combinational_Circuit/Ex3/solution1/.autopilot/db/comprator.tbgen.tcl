...
set C_modelArgList {
	...
	{ b2 uint 1 regular  }
	{ b3 uint 1 regular  }
	{ M int 1 regular {pointer 1}  }
	{ N int 1 regular {pointer 1}  }
	{ P int 1 regular {pointer 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "a0", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "M", "interface" : "wire", "bitwidth" : 1, "direction" : "WRITEONLY"} , 
 	{ "Name" : "N", "interface" : "wire", "bitwidth" : 1, "direction" : "WRITEONLY"} , 
 	{ "Name" : "P", "interface" : "wire", "bitwidth" : 1, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ M sc_out sc_lv 1 signal 8 } 
	{ N sc_out sc_lv 1 signal 9 } 
	{ P sc_out sc_lv 1 signal 10 } 
}
set NewPortList {[ 
	{ "name": "a0", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "a0", "role": "default" }} , 
 	...
 	{ "name": "M", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "M", "role": "default" }} , 
 	{ "name": "N", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "N", "role": "default" }} , 
 	{ "name": "P", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "P", "role": "default" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "M", "Type" : "None", "Direction" : "O"},
			{"Name" : "N", "Type" : "None", "Direction" : "O"},
			{"Name" : "P", "Type" : "None", "Direction" : "O"}]}]}
...
set Spec2ImplPortList { 
	...
	M { ap_none {  { M out_data 1 1 } } }
	N { ap_none {  { N out_data 1 1 } } }
	P { ap_none {  { P out_data 1 1 } } }
}
